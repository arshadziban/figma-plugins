...
// Compiled by hand from code.ts (no build step in this repo). If you change
// code.ts, keep this file in sync, or run `npx tsc` after `npm install`.
...
async function buildColorScaleFrame(base) {
